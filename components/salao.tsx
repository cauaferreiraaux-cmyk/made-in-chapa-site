...
export function Salao() {
  ...
  return (
    <section
      id="salao"
      className="relative isolate scroll-mt-24 overflow-hidden border-y border-borda bg-carvao-2 py-16 sm:py-28"
    >
      <div className="halo -bottom-32 left-1/4" aria-hidden />
        ...
        <Revelar>
          ...
          <div className="mt-5 space-y-4 sm:mt-6 sm:space-y-5">
            {sobre.paragrafos.map((paragrafo) => (
              <p key={paragrafo} className="text-base leading-relaxed text-fumaca sm:text-lg">
                {paragrafo}
              </p>
            ))}
          </div>
